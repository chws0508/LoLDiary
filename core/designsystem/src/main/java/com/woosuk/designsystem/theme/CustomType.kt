...
data class WoosukTypography(
    ...
    val bodyDoubleExtraLageMedium: TextStyle = TextStyle(
        fontFamily = GraphikFont,
        fontWeight = FontWeight.Medium,
        fontSize = 20.sp,
        lineHeight = 20.8.sp,
    ...
    val bodyDoubleExtraLargeRegular: TextStyle = TextStyle(
        fontFamily = GraphikFont,
    ...
    val bodyExtraLargeMedium: TextStyle = TextStyle(
        fontFamily = GraphikFont,
        fontWeight = FontWeight.Medium,
        fontSize = 18.sp,
        lineHeight = 23.2.sp,
    ...
    val bodyExtraLargeRegular: TextStyle = TextStyle(
        fontFamily = GraphikFont,
        fontWeight = FontWeight.Normal,
        fontSize = 18.sp,
        lineHeight = 23.2.sp,
    ...
    val bodyExtraSmallMedium: TextStyle = TextStyle(
        fontFamily = GraphikFont,
        fontWeight = FontWeight.Medium,
        fontSize = 10.sp,
        lineHeight = 25.2.sp,
    ...
    val bodyExtraSmallRegular: TextStyle = TextStyle(
        fontFamily = GraphikFont,
        fontWeight = FontWeight.Normal,
        fontSize = 10.sp,
        lineHeight = 25.2.sp,
