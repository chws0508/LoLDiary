...
import com.woosuk.data.network.dto.toDomain
import com.woosuk.data.persistence.UserDao
import com.woosuk.data.persistence.entitiy.toDomain
import com.woosuk.data.persistence.entitiy.toEntity
...
internal class DefaultUserRepository @Inject constructor(
    ...
    override suspend fun getCurrentUserAccount() = withContext(Dispatchers.IO) {
    ...
    override suspend fun getPreviousUserAccounts(): List<UserAccount> =
        userDao.getPreviousUsers().toDomain()
